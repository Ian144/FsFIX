...
let newOrderMultilegMsg = newOrderMultileg |> Fix44.MessageDU.NewOrderMultileg
...
let legA = {    MkInstrumentLegFG (LegSymbol "BCDEF") with LegSymbolSfx = "PQRS" |> sToOptLegSym } |> MkNoLegsGrp
let legB = {    MkInstrumentLegFG (LegSymbol "CDEFG") with LegSymbolSfx = "QRST" |> sToOptLegSym } |> MkNoLegsGrp
let legC = {    MkInstrumentLegFG (LegSymbol "DEFGH") with LegSymbolSfx = "RSTU" |> sToOptLegSym } |> MkNoLegsGrp
...
let qsr2Bytes               = "8=FIX.4.4|9=140|35=a|34=99|49=senderCompID|52=20071123-05:30:00.000|56=targetCompID|55=ABCDE|555=3|600=BCDEF|601=PQRS|600=CDEFG|601=QRST|600=DEFGH|601=RSTU|10=134|"B |> Array.map convFieldSep
let qsr2IncNestedGroupBytes = "8=FIX.4.4|9=246|35=a|34=99|49=senderCompID|52=20071123-05:30:00.000|56=targetCompID|55=ABCDE|555=3|600=BCDEF|601=PQRS|604=2|605=12345|606=QWERTYU|605=23456|606=ASDFGHJ|600=CDEFG|601=QRST|604=1|605=34567|606=ZXCVBNM|600=DEFGH|601=RSTU|604=1|605=45678|606=POIUYTR|10=043|"B  |> Array.map convFieldSep
...
type BenchmarkMsgReadWrite () =
    ...
    [<Benchmark>]
    member this.WriteQuoteStatusRequest () =
    ...
    [<Benchmark>]
    member this.ReadQuoteStatusRequest () =
        let msg = MsgReadWrite.ReadMessage qsr2Bytes qsr2Bytes.Length index
        ()

    [<Benchmark>]
    member this.ReadQuoteStatusRequestNestedGroups () =
        let msg = MsgReadWrite.ReadMessage qsr2IncNestedGroupBytes qsr2IncNestedGroupBytes.Length index
        ()
