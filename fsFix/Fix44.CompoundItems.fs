...
type Instrument = {
    ...
    EncodedIssuerLen: EncodedIssuerLen option
    EncodedIssuer: EncodedIssuer option
    SecurityDesc: SecurityDesc option
    EncodedSecurityDescLen: EncodedSecurityDescLen option
...
type UnderlyingInstrument = {
    ...
    EncodedUnderlyingIssuerLen: EncodedUnderlyingIssuerLen option
    EncodedUnderlyingIssuer: EncodedUnderlyingIssuer option
    UnderlyingSecurityDesc: UnderlyingSecurityDesc option
    EncodedUnderlyingSecurityDescLen: EncodedUnderlyingSecurityDescLen option
...
type InstrumentLeg = {
    ...
    EncodedLegIssuerLen: EncodedLegIssuerLen option
    EncodedLegIssuer: EncodedLegIssuer option
    LegSecurityDesc: LegSecurityDesc option
    EncodedLegSecurityDescLen: EncodedLegSecurityDescLen option
